...
public class MasterAppActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataList.add(new DrawerItem("Novo Encontro", R.drawable.ic_action_map));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	//return false;
         ...
         case R.id.action_logout:
        	 logout();
        	 abrirTela(FirstActivity.class, true);
             return true;
         default:
	...
	public void SelectItem(int possition) {
        ...
        switch (possition) {
            case 0:
                ...
                break;
            case 1:
            	fragment = new FragmentNovoEncontro();
                break;
            case 2:
    ...
    public void abrirTela(Class<?> activity, boolean finish) {
